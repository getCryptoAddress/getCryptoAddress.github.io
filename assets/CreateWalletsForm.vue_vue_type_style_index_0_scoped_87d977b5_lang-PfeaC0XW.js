import{e as a,a0 as _,f as o,g as s,j as x,u as C,k as u,m as w,n as z,o as i,as as y,bF as I,i as f,M as T,O as L,l as R,ak as H,Q as M,K as V,bG as N,P as F,al as K,bH as W}from"./index-Qa7pNrPl.js";const G=a("divider",`
 position: relative;
 display: flex;
 width: 100%;
...
`,[a("thing-avatar",`
 ...
 margin-top: 12px;
 `)])])]),U=Object.assign(Object.assign({},u.props),{title:String,titleExtra:String,description:String,descriptionClass:String,descriptionStyle:[String,Object],content:String,contentClass:String,contentStyle:[String,Object],contentIndented:Boolean}),re=x({name:"Thing",props:U,setup(r,{slots:e}){const{mergedClsPrefixRef:n,inlineThemeDisabled:d,mergedRtlRef:m}=C(r),c=u("Thing","-thing",J,W,r,n),l=R("Thing",m,n),v=w(()=>{const{self:{titleTextColor:g,textColor:t,titleFontWeight:b,fontSize:p},common:{cubicBezierEaseInOut:$}}=c.value;return{"--n-bezier":$,"--n-font-size":p,"--n-text-color":t,"--n-title-font-weight":b,"--n-title-text-color":g}}),h=d?z("thing",void 0,v,r):void 0;return()=>{var g;const{value:t}=n,b=l?l.value:!1;return(g=h?.onRender)===null||g===void 0||g.call(h),i("div",{class:[`${t}-thing`,h?.themeClass,b&&`${t}-thing--rtl`],style:d?void 0:v.value},e.avatar&&r.contentIndented?i("div",{class:`${t}-thing-avatar`},e.avatar()):null,i("div",{class:`${t}-thing-main`},!r.contentIndented&&(e.header||r.title||e["header-extra"]||r.titleExtra||e.avatar)?i("div",{class:`${t}-thing-avatar-header-wrapper`},e.avatar?i("div",{class:`${t}-thing-avatar`},e.avatar()):null,e.header||r.title||e["header-extra"]||r.titleExtra?i("div",{class:`${t}-thing-header-wrapper`},i("div",{class:`${t}-thing-header`},e.header||r.title?i("div",{class:`${t}-thing-header__title`},e.header?e.header():r.title):null,e["header-extra"]||r.titleExtra?i("div",{class:`${t}-thing-header__extra`},e["header-extra"]?e["header-extra"]():r.titleExtra):null),e.description||r.description?i("div",{class:[`${t}-thing-main__description`,r.descriptionClass],style:r.descriptionStyle},e.description?e.description():r.description):null):null):i(y,null,e.header||r.title||e["header-extra"]||r.titleExtra?i("div",{class:`${t}-thing-header`},e.header||r.title?i("div",{class:`${t}-thing-header__title`},e.header?e.header():r.title):null,e["header-extra"]||r.titleExtra?i("div",{class:`${t}-thing-header__extra`},e["header-extra"]?e["header-extra"]():r.titleExtra):null):null,e.description||r.description?i("div",{class:[`${t}-thing-main__description`,r.descriptionClass],style:r.descriptionStyle},e.description?e.description():r.description):null),e.default||r.content?i("div",{class:[`${t}-thing-main__content`,r.contentClass],style:r.contentStyle},e.default?e.default():r.content):null,e.footer?i("div",{class:`${t}-thing-main__footer`},e.footer()):null,e.action?i("div",{class:`${t}-thing-main__action`},e.action()):null))}}});export{re as N,ee as a,Y as b,Z as c};
